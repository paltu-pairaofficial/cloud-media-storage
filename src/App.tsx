...
const DriveDashboard: React.FC = () => {
  ...
  const resetTokenFromUrl = urlParams.get('resetToken') || urlParams.get('token');

  if (resetTokenFromUrl || !isAuthenticated || !user) {
    return <AuthView initialResetToken={resetTokenFromUrl} />;
  }
