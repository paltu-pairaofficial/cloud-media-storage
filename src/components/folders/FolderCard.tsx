    ...
    >
      ...
      <div className="flex items-center gap-3.5 min-w-0 flex-1">
        <div className="relative shrink-0">
          <div
            className="w-11 h-11 rounded-[16px] bg-[#F5F5F0] flex items-center justify-center border border-[#E5E5DF]/70 transition-transform"
            style={{
          ...
          <button
            ...
            className={`absolute -top-1 -left-1 w-5 h-5 rounded-md flex items-center justify-center transition-all cursor-pointer ${
              isSelected
                ? 'bg-[#5A5A40] text-white shadow-xs opacity-100'
                : selectedFolderIds.length > 0
                ? 'bg-white border border-[#D1D1CB] text-transparent hover:border-[#5A5A40] opacity-80 hover:opacity-100'
                : 'bg-white border border-[#D1D1CB] text-transparent hover:border-[#5A5A40] opacity-0 group-hover:opacity-100'
            }`}
