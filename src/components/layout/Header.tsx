      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden lg:flex items-center gap-3 mr-1">
          <div className="text-right">
            ...
            <p className="text-[10px] text-[#8E8E8A] truncate max-w-[140px]">{user?.email || ''}</p>
          </div>
        </div>
            ...
            <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-2xl shadow-xl border border-[#E5E5DF] py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
              ...
              <div className="p-1">
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-medium text-[#71716A] hover:text-[#2D2D2A] hover:bg-[#F5F5F0] rounded-xl transition-colors cursor-pointer"
                >
